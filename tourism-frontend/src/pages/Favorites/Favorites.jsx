              ...
              >
                <Card className="h-full border-none shadow-md hover:shadow-xl group flex flex-col">
                  <Link to={`/services/${service.id}`} className="block relative aspect-video overflow-hidden shrink-0">
                    <img 
                      src={service.image || service.images?.[0] || 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&q=80&w=800'} 
                  ...
                  <div className="p-8 space-y-6 flex flex-col flex-grow">
                    <div className="space-y-2 flex-grow">
                      ...
                      <div className="flex items-center gap-2 text-slate-400 text-sm">
                        ...
                        <span>{service.location || service.city_name}</span>
                      </div>
                    </div>
