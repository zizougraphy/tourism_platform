...
import { Compass, Menu, X, User as UserIcon, Heart, Calendar, LogOut, LayoutDashboard } from 'lucide-react';
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <span className={cn(
            "text-2xl font-bold tracking-tighter font-heading",
          ...
          {!isAuthenticated ? (
            ...
            <div className="relative">
              <button 
                ...
                id="user-menu-button"
              >
                <span className="text-sm font-bold text-slate-700">{user?.name || 'Traveler'}</span>
                {user?.photoURL ? (
                  ...
                  <>
                    ...
                    >
                      <div className="px-4 py-3 border-b border-slate-50 mb-1">
                        ...
                        <div className="text-sm font-bold truncate text-slate-700">{user?.email}</div>
                      </div>
                      
                      {user?.role === 'service_provider' && (
                        <Link to="/dashboard" onClick={() => setShowUserMenu(false)} className="flex items-center gap-3 px-4 py-2 hover:bg-slate-50 text-slate-700 transition-colors">
        ...
        {/* Mobile Menu Toggle */}
        <button
          className={cn("md:hidden p-2 rounded-lg", isScrolled || location.pathname !== '/' ? "text-slate-900" : "text-white")}
