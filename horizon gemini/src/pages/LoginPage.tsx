      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-brand-900 items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg space-y-8 text-white">
          ...
          <div className="space-y-4">
            <h2 className="text-5xl font-bold leading-tight">Welcome back to your global journey.</h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-16 bg-white">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tight">Login to Horizon</h1>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Button variant="outline" size="md" className="h-12 border-slate-200 text-slate-600 rounded-2xl">
